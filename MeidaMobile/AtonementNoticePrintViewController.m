...
//        [AtonementNoticePrintViewController generateDefaultsForNotice:self.notice caseId:self.caseID];
    ...
    self.view.frame = CGRectMake(0, 0, 946, 1300);
    [super viewDidLoad];
...
- (void)loadPageInfo{
    ...
    self.textCaseReason.text = [NSString stringWithFormat:@"因交通事故%@",  proveInfo.case_short_desc];
...
//    notice.check_organization = @"事务中心";
...
-(NSArray *) subString2:(NSString *)str {
    ...
    if (str != nil){
        ...
        //从指定字符串截取到末尾
        NSString * tempStr2 = [str substringFromIndex:str.length/2];
