...
-(NSString*)generateCommonInquireText{
    ...
    NSString* text = [NSString stringWithFormat:@"%@%@%@",@"问：你好，我们是",organizationName,@"路政员，向你了解一些情况，希望你如实回答，不得说假话做伪证，否则是要负法律责任的，你明白吗？\n" ];
    text = [NSString stringWithFormat:@"%@%@",text,@"答：明白。\n"];
